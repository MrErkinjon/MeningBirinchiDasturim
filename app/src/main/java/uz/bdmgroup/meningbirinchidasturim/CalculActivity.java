...
public class CalculActivity extends AppCompatActivity {
    private Button b1,b2,b3,b4,b5,b6,b7,b8,b9,b0,b00;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b00.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (t1.getText().length() > 0) {
                    ...
                    t1.setText(t1.getText().toString() + "00");
                }else {
                    t1.setText(t1.getText().toString() + "0.0");
                }
            }
        });
        ...
        b_para2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (t2.getText().toString()=="" || t1.getText().toString()=="") {
                    t2.setText("Error");
                } else {
